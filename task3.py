...
def get_purchase_info():
    # TODO Use input to collect and store the item name into the variable item.
    # TODO Use input to collect and store the item price into the variable price
    # TODO Use input to collect and store the item quantity into the variable quantity.
